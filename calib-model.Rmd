...
these files were archived on the USGS Water Resources [NSDI Node](http://dx.doi.org/10.5066/F7C827DT).
...
Note that the executable version has been updated from 1.2, included with the model archive, to 1.3.
...
```{r leaflet_map, fig.width=5.00, fig.height=5.00, eval=TRUE}
