...
```{r eval_budget_archive, message=FALSE, eval=TRUE}
dir.run <- "archive"
...
```{r eval_budget_scenario, message=FALSE, eval=TRUE}
dir.run <- "model"
eval(parse(text = unlist(app.d.chunks[paste0("read_budget_", 1:2)])))
```
...
```{r eval_head_archive, message=FALSE, eval=TRUE}
dir.run <- "archive"
...
```{r eval_head_scenario, message=FALSE, eval=TRUE}
dir.run <- "model"
eval(parse(text = app.d.chunks[["read_head"]]))
```
